const refs = {
    ...
    authEmailInput: document.querySelector(".authrization-modal-form__input-email"),
    authPasswordInput: document.querySelector(".authrization-modal-form__input-password"),
    ...
    sigInPasswordInput: document.querySelector(".sign-in-modal-form__input-password"),
  ...
  function checkAuthForm() {
    if (localStorage.getItem('form-state') === null) {
        ...
        const passwordData = JSON.parse(localStorage.getItem('form-state')).password;
        if (emailData !== '') {
  ...
  function checkSigInForm() {
    if (localStorage.getItem('form-state') === null) {
        ...
        const newPasswordData = JSON.parse(localStorage.getItem('form-state')).password;
